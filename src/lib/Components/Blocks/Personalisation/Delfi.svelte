...
>
	<h2 class="text-lg font-semibold">Tere Delfi 👋🏼</h2>

	<div class="prose dark:prose-invert">
		<p>
			Siin on minu veebipõhine CV <a
				href="https://delfimeedia.ee/talents/seenior-front-end-arendaja/"
				>seenior front-end arendaja</a
			> positsioonile.
		</p>
		<p>
